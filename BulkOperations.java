...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        list.add(3);
        list.add(4);
        boolean r1 = list.contains(1); //true, and it only verify if contains one element
        ...
        elements.add(2);
        elements.add(5);
        boolean r3= list.containsAll(elements);
        ...
        boolean r4 =  list2.containsAll(   Arrays.asList(10, 20, 4)   );

        Integer[] arr = {10, 20, 4};
        boolean r5 =  list2.containsAll(   Arrays.asList( arr )   );
